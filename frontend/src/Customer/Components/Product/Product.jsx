...
import { findProducts } from "../../../StateManage/Product/action";
        ...
        <main className="mx-auto  px-4 sm:px-6 lg:px-20">
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
              <div>
                <div className="lg:flex lg:justify-between lg:mt-2 hidden ">
                  <h1 className="font-semibold text-2xl opacity-12">Filters</h1>
                  <FilterListIcon />
                </div>
