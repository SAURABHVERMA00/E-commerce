        ...
        <Grid item container className="shadow-xl rounded-md p-5 border" sx={{alignItems:"center" , justifyContent:"space-between"}}>
            ...
            <Grid item xs={6}>
                <div className="flex items-center space-x-4">
                    <img className="w-[5rem] h-[8rem] object-cover object-top" src="https://ivalinmabia.com/cdn/shop/files/azhagi-blue-cotton-saree-sarees-975.webp?v=1725378848&width=1780" alt="" />
