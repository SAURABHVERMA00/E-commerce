...
export const GET_ALL_ORDERS_BY_REQUEST="GET_ALL_ORDERS_BY_REQUEST";
export const GET_ALL_ORDERS_BY_SUCCESS="GET_ALL_ORDERS_BY_SUCCESS";
export const GET_ALL_ORDERS_BY_FAILURE="GET_ALL_ORDERS_BY_FAILURE";
